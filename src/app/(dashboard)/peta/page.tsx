...
const PetaMap = dynamic(() => import('@/components/peta/PetaMap'), { ssr: false, loading: () => (
  <div className="flex items-center justify-center h-full" style={{ background: 'rgba(10,22,40,0.5)', borderRadius: 12 }}>
    <div className="text-center">
      <div className="w-8 h-8 border-2 border-t-transparent rounded-full animate-spin mx-auto mb-3" style={{ borderColor: '#fbbf24', borderTopColor: 'transparent' }} />
    ...
    <div className="flex flex-col h-full space-y-4 animate-fade-in" style={{ minHeight: 'calc(100vh - 120px)' }}>
      <div>
        <h2 className="text-xl font-bold flex items-center gap-2" style={{ color: '#1e293b' }}>
          <Map size={20} style={{ color: '#fbbf24' }} /> Peta Interaktif Sebaran Bantuan
        </h2>
